...
namespace odm.utils.entities {
	...
	public class AvailableResolution {
		odm.models.VideoResolution _resolution;
		public odm.models.VideoResolution Resolution { 
			get{
				return _resolution;
			}
			set{
	...
	public class AvailableEncoder {
		odm.models.VideoEncoder.Encoding _encoding;
		public odm.models.VideoEncoder.Encoding Encoding {
			get { return _encoding; }
			set { _encoding = value; }
		}
		List<odm.models.VideoResolution> _resolutionsList {
			get {
