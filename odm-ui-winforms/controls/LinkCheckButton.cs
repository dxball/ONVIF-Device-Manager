...
namespace odm.controls
{
    public partial class LinkCheckButton : UserControl
    {
		...
		public bool IsCheckable { get { return _checkBox.Visible; } set { _checkBox.Visible = value; } }
        ...
        public LinkCheckButton()//, Panel propContainer)//LinkButtonSetting lbtnSet)
        {
            InitializeComponent();
		...
		private void _checkBox_CheckedChanged(object sender, EventArgs e) {
			if (silendSwitch == false) {
				...
				if (ChBoxSwitched != null)
					ChBoxSwitched(_checkBox.Checked ,OnSwitchError);
			} else
