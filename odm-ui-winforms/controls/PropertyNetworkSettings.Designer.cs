...
namespace odm.controls
{
    partial class PropertyNetworkSettings
    {
        ...
        private void InitializeComponent()
        {
			...
			this._tbmDNS = new odm.controls.IPAddressControl();
			this._tbmGate = new odm.controls.IPAddressControl();
			this._tbmSubnet = new odm.controls.IPAddressControl();
			this._tbmIPaddr = new odm.controls.IPAddressControl();
