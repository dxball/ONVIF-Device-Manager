...
namespace odm.controls {
	public partial class TitleBar : UserControl {
		...
		void InitControls() {
			...
			var defItem = list.Where(x => x.Unwrap().iso3 == odm.utils.properties.Settings.Default.DefaultLocaleIso3).FirstOrDefault();
		...
		private void _cmbLocale_SelectedIndexChanged(object sender, EventArgs e) {
			...
			if (selection == null) {
				...
				odm.utils.properties.Settings.Default.DefaultLocaleIso3 = Language.Current.iso3;
