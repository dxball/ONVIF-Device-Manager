...
namespace odm.controls.regionEditor {
	public abstract class BaseMarker: BaseRegion {
		...
		protected virtual void SetMarkerUpSide(Point pe) {
			int oUpY = _marker.Y;
		...
		protected virtual void SetMarkerBottomSide(Point pe) {
		...
		protected virtual void SetMarkerLeftSide(Point pe) {
		...
		protected virtual void SetMarkerRightSide(Point pe) {
		...
		public override void mousedclick(MouseEventArgs e, Point scrPoint) {
			if (e.Button == MouseButtons.Left) {
				if (RegionUtils.CheckIfInRoundRectangle(RegionUtils.ScreenToStream(e.Location, ClientRect, Resolution), _marker))
