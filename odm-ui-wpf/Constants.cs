...
namespace odm {
	...
	//    public static readonly Color colLinkButtonsIitial = Color.FromRgb(0, 0, 255);
	//    public static readonly Color colLinkButtonsClicked = Color.FromRgb(150, 0, 200);
	//    public static readonly Color colLinkButtonsHovered = Color.FromRgb(150, 150, 255);
	//    public static readonly Color colControlBackground = Color.FromRgb(240, 240, 240);
	//    public static readonly Color colActiveControlBackground = Color.FromRgb(240, 250, 255);
	//    public static readonly Color colTitleBackground = Color.FromRgb(210, 210, 210);
	//    public static readonly Color colActiveTitleBackground = Color.FromRgb(240, 240, 250);
	//    public static readonly Color colMainWindowBackkground = Color.FromRgb(235, 235, 235);
	//    public static readonly Color colHighlightedImage = Color.FromRgb(0, 255, 0);
	//}
