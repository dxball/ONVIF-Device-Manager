...
namespace odm.ui.controls {
	...
	public class CustomWindow : Window {
		...
		static CustomWindow() {
			...
			CommandManager.RegisterClassCommandBinding(typeof(CustomWindow), new CommandBinding(CloseCommand, (o, e) => {
				var wnd = (CustomWindow)o;
				wnd.Close();
			}));

			CommandManager.RegisterClassCommandBinding(typeof(CustomWindow), new CommandBinding(MaximizeCommand, (o, e) => {
				var wnd = (CustomWindow)o;
			...
			CommandManager.RegisterClassCommandBinding(typeof(CustomWindow), new CommandBinding(MinimizeCommand, (o, e) => {
				var wnd = (CustomWindow)o;
