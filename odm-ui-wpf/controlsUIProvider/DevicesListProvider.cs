...
namespace odm.controlsUIProvider {
	public class DevicesListProvider : BaseUIProvider, IDevicesListProvider {
		DeviceListPanel _devLsrCtrl;
		public DeviceListPanel DevListControl {
		...
		public void CreateDeviceListControl(Action<DeviceDescriptionModel> itemSelected, Action refreshDevicesList, Action CreateD) {
			_devLsrCtrl = new DeviceListPanel(itemSelected, refreshDevicesList, CreateD);
		...
		public void RemoveDeviceDescription(IDeviceDescriptionModel devModel) {
			_devLsrCtrl.RemoveItem(devModel);
		}
		public void AddDeviceDescription(IDeviceDescriptionModel devModel) {
