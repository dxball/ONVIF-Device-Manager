...
namespace nvc.controls
{
    public partial class DevicesListControl : UserControl
    {
		...
		void _lviewDevices_ColumnWidthChanged(object sender, ColumnWidthChangedEventArgs e) {
			nvc.properties.Settings.Default.DevicesListControlHeaderIPWidth = _columnHeaderIP.Width;
			nvc.properties.Settings.Default.DevicesListControlHeaderNameWidth = _columnHeaderName.Width;
			nvc.properties.Settings.Default.DevicesListControlHeaderTypeWidth = _columnHeaderType.Width;
			nvc.properties.Settings.Default.Save();
		}
