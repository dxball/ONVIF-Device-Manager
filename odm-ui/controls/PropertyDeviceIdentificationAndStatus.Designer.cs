...
namespace nvc.controls
{
    partial class PropertyDeviceIdentificationAndStatus
    {
        ...
        private void InitializeComponent()
        {
			...
			this._dtCurTime = new System.Windows.Forms.DateTimePicker();
			this._lblCutTime = new System.Windows.Forms.TextBox();
			...
			this.panel1.Controls.Add(this._dtCurTime);
			this.panel1.Controls.Add(this._lblCutTime);
			...
			// _dtCurTime
			// 
			this._dtCurTime.Anchor = ((System.Windows.Forms.AnchorStyles)((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Right)));
			this._dtCurTime.Enabled = false;
			this._dtCurTime.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			this._dtCurTime.Location = new System.Drawing.Point(166, 159);
			this._dtCurTime.Name = "_dtCurTime";
			this._dtCurTime.Size = new System.Drawing.Size(249, 20);
			this._dtCurTime.TabIndex = 32;
			this._dtCurTime.Visible = false;
			// 
			// _lblCutTime
			// 
			this._lblCutTime.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
						| System.Windows.Forms.AnchorStyles.Right)));
			this._lblCutTime.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			this._lblCutTime.Location = new System.Drawing.Point(3, 159);
			this._lblCutTime.Name = "_lblCutTime";
			this._lblCutTime.ReadOnly = true;
			this._lblCutTime.Size = new System.Drawing.Size(157, 20);
			this._lblCutTime.TabIndex = 28;
			this._lblCutTime.Text = "Time";
			this._lblCutTime.Visible = false;
			// 
			// _tbIP
			// 
			...
			this._saveCancelControl.Location = new System.Drawing.Point(3, 182);
			this._saveCancelControl.Margin = new System.Windows.Forms.Padding(0);
			this._saveCancelControl.Name = "_saveCancelControl";
			this._saveCancelControl.Size = new System.Drawing.Size(228, 23);
			...
			this.Size = new System.Drawing.Size(424, 257);
		...
		private System.Windows.Forms.DateTimePicker _dtCurTime;
		private System.Windows.Forms.TextBox _lblCutTime;
    }
}
