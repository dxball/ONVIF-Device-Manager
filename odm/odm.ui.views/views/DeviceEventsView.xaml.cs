...
namespace odm.ui.controls {
	public partial class DeviceEventsView : BasePropertyControl, INotifyPropertyChanged {
		...
		void DeviceEventsView_Loaded(object sender, System.Windows.RoutedEventArgs e) {
            ...
            colId.CreateBinding(GridViewColumn.HeaderProperty, Strings, s => s.colId);
		...
		public odm.ui.viewModels.EventDescriptor LastEvent { get { return (odm.ui.viewModels.EventDescriptor)GetValue(LastEventProperty); } set { SetValue(LastEventProperty, value); } }
		public static readonly DependencyProperty LastEventProperty = DependencyProperty.Register("LastEvent", typeof(odm.ui.viewModels.EventDescriptor), typeof(DeviceEventsView));

		public ObservableCollection<odm.ui.viewModels.EventDescriptor> events { get; set; }
